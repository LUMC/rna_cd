...
latex_documents = [
    (master_doc, 'rna_cd.tex', 'rna\\_cd Documentation',
     'Sander Bollen, Leiden University Medical Center', 'manual'),
]
...
man_pages = [
    (master_doc, 'rna_cd', 'rna_cd Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'rna_cd', 'rna_cd Documentation',
     author, 'rna_cd', 'One line description of project.',
     'Miscellaneous'),
]
